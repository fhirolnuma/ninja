...
function emnanon_child_custom_css() {
	...
	$faq_section_btn_background_color = get_theme_mod( 'faq_section_btn_background_color', '#9b8d77' );
	$faq_section_btn_text_color = get_theme_mod( 'faq_section_btn_text_color', '#fff' );
...
.ticker-section a{color:<?php echo $newsticker_text_color; ?>;}
.ticker-section a:hover{color:<?php echo $link_hover; ?>;}
...
.accordion-faq-header p{color:<?php echo $faq_sub_title_colorr; ?>;}
...
.faq-section-btn a{background-color:<?php echo $faq_section_btn_background_color; ?>;color:<?php echo $faq_section_btn_text_color; ?>;}
<?php endif; ?>

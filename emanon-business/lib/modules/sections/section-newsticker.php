...
<div class="eb-ticker-section">
	<div class="container">
		...
		<ul class="ticker-title">
			...
			<li><span class="ticker-date"><?php echo esc_html( get_the_date() ); ?></span><i class="fa fa-angle-right"></i><a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></li>

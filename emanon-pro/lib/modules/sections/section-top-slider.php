...
<div class="slider">
	...
	<div class="slider-message">
		<div id="flexslider" class="flexslider-height clearfix" data-speed="<?php echo esc_attr( $slider_text_speed ); ?>" data-slideshow="<?php echo esc_attr($slider_text_toggle); ?>" data-animation="<?php echo esc_attr( $slider_text_animation ); ?>" >
			<ul id="slides">
			<?php if ( $slider_title_1 || $slider_sub_title_1 ): ?>
				<?php if ( is_mobile() ): ?>
				<li class="wow fadeInUp" data-wow-duration="0.2">
				...
				<?php else: ?>
				<li>
					<h2 class="slider-title wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="1.2s"><?php echo esc_html( $slider_title_1 ); ?></h2>
					<p class="slider-sub-title wow fadeInUp" data-wow-duration="0.2s" data-wow-delay="1.6s"><?php echo nl2br( esc_html( $slider_sub_title_1 ) ); ?></p>
				</li>
				<?php endif; ?>
			<?php endif; ?>
		...
		<div class="slider-btn wow fadeInUp" data-wow-duration="1.0s" data-wow-delay="1.8s">

...
<div class="relative">
	...
	<div class="top-bar">
		<div class="container">
			<div class="col12">
				<p itemprop="description"><?php echo esc_html( $lp_header_description ); ?></p>
			</div>
		</div>
	</div>
	<!--end top bar-->
	...
	<?php if ( $display_hanger_nav ) : ?>
		<div class="modal-menu">
			<a href="#modal-global-nav-lp" data-remodal-target="modal-global-nav-lp" class="modal-gloval-btn">

...
*/
	$header_tel_text_icon_pc = get_theme_mod( 'header_tel_text_icon_pc', 'fa fa-phone' );
...
<ul>
	...
	<li class="header-cta-tell">
		<div>
			<?php if( $header_tel_text_icon_pc ) { ?><i class="<?php echo esc_html( $header_tel_text_icon_pc ); ?>"></i><?php } ?>

...
/*----------------------------------------------------------------------------------*/
	...
	if ( !function_exists( 'emanon_customize_sanitize_firstview_layout_type' ) ):
	function emanon_customize_sanitize_firstview_layout_type( $input ) {
		if( $input == 'no_display' || $input == 'slider' || $input == 'slider-content' || $input == 'featured' || $input == 'pagebox' || $input == 'video' || $input == 'eyecatch' ) {
		return $input;
		} else {
			return 'no_display';
		}
	...
	function emanon_customize_sanitize_featured_image_layout_type( $input ) {
	...
	function emanon_customize_sanitize_mobile_footer_btn_style( $input ) {
		if( $input == 'no_display' || $input == 'display' || $input == 'display_no_share_button' ) {
		return $input;
		} else {
			return 'no_display';
		}

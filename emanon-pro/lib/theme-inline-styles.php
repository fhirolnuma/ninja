...
function emnanon_custom_css() {
  ...
  $slider_responsive = get_theme_mod( 'slider_responsive', false );
  ...
  $header_image_opacity = get_theme_mod( 'header_image_opacity', 0 );
  ...
  $faq_title_color = get_theme_mod( 'faq_title_color', '#000c15' );
  $faq_sub_title_color = get_theme_mod( 'faq_sub_title_color', '#303030' );
  $faq_section_background_color = get_theme_mod( 'faq_section_background_color', '#fff' );
  $faq_section_text_color = get_theme_mod( 'faq_section_text_color', '#303030' );
  $faq_section_q_icon_color = get_theme_mod( 'faq_section_q_icon_color', '#9b8d77' );
  $faq_section_a_icon_color = get_theme_mod( 'faq_section_a_icon_color', '#b5b5b5' );
...
.pagination a:hover,.pagination .current{background-color:<?php echo $main_color;?>;border:1px solid <?php echo $main_color; ?>;}
...
.author-profile-text h4 a{color:<?php echo $link_color; ?>;}
...
/*--link hover--*/
a:hover,.header-site-name a:hover,.global-nav a:hover,.side-widget a:hover,.side-widget li a:hover:before,#wp-calendar a:hover,.entry-title a:hover,.footer-follow-btn a:hover .fa{color:<?php echo $link_hover; ?>;}
.scroll-nav-inner li:after{background-color:<?php echo $link_hover; ?>;}
.featured-title h2:hover{color:<?php echo $link_hover; ?>;}
.author-profile-text h4 a:hover{color:<?php echo $link_hover; ?>;}
...
.tagcloud a:hover{border:1px solid <?php echo $link_hover;?>;color:<?php echo $link_hover; ?>;}
...
#sidebar-cta {border:4px solid <?php echo $link_hover; ?>;}
/*--btn color--*/
.btn-more{background-color:<?php echo $btn_background_color; ?>;border:1px solid <?php echo $btn_background_color; ?>;}
...
.btn-border{display:block;padding:8px 16px;border:1px solid <?php echo $btn_background_color; ?>;}
...
<?php else: ?>
.top-bar{background-color:<?php echo $header_tagline_background_color; ?>;border-bottom:1px solid <?php echo $header_tagline_background_color; ?>;}
<?php endif; ?>
.top-bar h1,.header-table h1,.top-bar p,.header-table p{color:<?php echo $header_tagline_text_color; ?>}
.header-table h1,.header-table p{font-size:<?php echo $header_tagline_font_size; ?>px;}
.header-site-name a{color:<?php echo $header_site_title_color; ?>;font-size:<?php echo $header_sitename_font_size_mobile; ?>px;}
.header-site-name a:hover{color:<?php echo $link_hover; ?>;font-size:<?php echo $header_sitename_font_size_mobile; ?>px;}
...
.header-site-name a:hover{font-size:<?php echo $header_sitename_font_size_pc; ?>px;}
}
...
/*--header cta-*/
.header-cta ul {line-height:<?php echo $mobile_header_area_height; ?>px;}
.header-cta-tell .fa{color:<?php echo $header_cta_icon_color; ?>;}
.header-cta-tell .tell-number, .header-cta-tell .tell-text{color:<?php echo $header_cta_text_color; ?>;}
...
<?php endif; ?>
@media screen and ( min-width: 768px ) {
.header-cta ul {line-height:<?php echo $header_area_height; ?>px;}
...
<?php if ( !$slider_responsive ): ?>
.bx-wrapper:before{position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(<?php echo $slider_background_color_degree; ?>deg, <?php echo $slider_background_color_start; ?>, <?php echo $slider_background_color_end; ?>)fixed;opacity: <?php echo $slider_image_opacity; ?>;content: "";z-index:100;}
<?php endif; ?>
<?php if ( $slider_responsive ): ?>
.bx-wrapper li:before{position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(<?php echo $slider_background_color_degree; ?>deg, <?php echo $slider_background_color_start; ?>, <?php echo $slider_background_color_end; ?>)fixed;opacity: <?php echo $slider_image_opacity; ?>;content: "";z-index:100;}
<?php endif; ?>
...
#bxslider li{height:<?php echo intval( $slider_image_height ); ?>px;background-position: center;background-size: cover;background-repeat:no-repeat;}
...
.slider-btn .btn{border:1px solid <?php echo $slider_btn_background_color; ?>;background-color:<?php echo $slider_btn_background_color; ?>;}
...
.slider-btn-bg:before{content:'';position:absolute;border:3px solid <?php echo $slider_btn_background_color; ?>;top:0;right:0;bottom:0;left:0;-webkit-transition:0.2s ease-in-out;transition:0.2s ease-in-out;z-index:-1;}
...
.slider-content-btn-bg:before{content:'';position:absolute;border:2px solid <?php echo $slider_content_text_color; ?>;top:0;right:0;bottom:0;left:0;-webkit-transition:0.2s ease-in-out;transition:0.2s ease-in-out;z-index:-1;}
...
.home .top-bar h1,.home .header-table h1{color:<?php echo $video_header_tagline_text_color; ?>}
...
.video-btn-bg:before{content:'';position:absolute;border:3px solid <?php echo $video_btn_background_color; ?>;top:0;right:0;bottom:0;left:0;-webkit-transition:0.2s ease-in-out;transition:0.2s ease-in-out;z-index:-1;}
...
.header-eyecatch-btn-bg:before{content:'';position:absolute;border:3px solid <?php echo $eyecatch_btn_background_color; ?>;top:0;right:0;bottom:0;left:0;-webkit-transition:0.2s ease-in-out;transition:0.2s ease-in-out;z-index:-1;}
...
.front-top-widget-box h2:after, .front-bottom-widget-box h2:after{position:absolute;top:100%;left: 30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
...
.entry-header h2:after{position:absolute;top:100%;left: 30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
...
.archive-title h1:after{position:absolute;top:100%;left: 30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-left-background' ): ?>
/*---左ボーダー＋背景--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
.entry-header h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
.archive-title h1{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-left' ): ?>
/*---左ボーダー--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;}
.entry-header h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;}
.archive-title h1{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-left-bottom' ): ?>
/*---左ボーダー+下ボーダ--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
.entry-header h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
.archive-title h1{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-bottom' ): ?>
/*--下ボーダー--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
.entry-header h2{padding:8px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
.archive-title h1{padding:8px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-bottom-two' ): ?>
/*---下ボーダー（2カラー）--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{margin-bottom: -1px;}
.front-top-widget-box h2 > span, .front-bottom-widget-box h2 > span{display:inline-block;padding:0 4px 4px 0;border-bottom:1px solid <?php echo $main_color; ?>;}
.entry-header {border-bottom:1px solid #e2e5e8;}
.entry-header h2{margin-bottom: -1px;}
.entry-header h2 > span{display:inline-block;padding:0 4px 4px 0;border-bottom:1px solid <?php echo $main_color; ?>;}
.archive-title {border-bottom:1px solid #e2e5e8;}
.archive-title h1{margin-bottom: -1px;}
.archive-title h1 > span{display:inline-block;padding:0 4px 4px 0;border-bottom:1px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-left-background-stripe' ): ?>
/*---左ボーダー＋背景 ストライプ--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background:-webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
.entry-header h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background:-webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
.archive-title h1{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background:-webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
<?php if ( $entry_section_title_style == 'border-top-bottom-stripe' ): ?>
/*--上下ボーダー ストライプ--*/
.front-top-widget-box h2, .front-bottom-widget-box h2{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background:repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
.entry-header h2{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background:repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
...
<?php endif; ?>
/*--アイキャッチ画像--*/
<?php if( $featured_image_layout == 'normal' ): ?>
.article-thumbnail img{padding:0 16px;}
@media screen and (min-width: 992px) {
.article-thumbnail img{padding: 0 24px;}
}
<?php endif; ?>
<?php if( $featured_image_layout == 'no_display' ): ?>
@media screen and (min-width: 992px) {
...
.article-body h2:after{position:absolute;top:100%;left: 30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h2_style == 'border-left-background' ): ?>
/*---左ボーダー＋背景--*/
.article-body h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
<?php endif; ?>
<?php if ( $h2_style == 'border-left' ): ?>
/*---左ボーダー--*/
.article-body h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h2_style == 'border-left-bottom' ): ?>
/*---左ボーダー+下ボーダ--*/
.article-body h2{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
<?php endif; ?>
<?php if ( $h2_style == 'border-bottom' ): ?>
/*--下ボーダー--*/
.article-body h2{padding:8px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
<?php endif; ?>
...
/*--上下ボーダー ストライプ--*/
.article-body h2{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background:repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
/*--h3 style--*/
...
/*---背景--*/
.article-body h3,.page-bottom-widget h3{padding:6px 0 6px 16px;background-color:<?php echo $main_color; ?>;color: #fff;}
<?php endif; ?>
<?php if ( $h3_style == 'balloon' ): ?>
/*---吹き出し--*/
.article-body h3,.page-bottom-widget h3{position:relative;padding:6px 16px;background-color:<?php echo $main_color; ?>;border-radius:4px;color:#fff;}
.article-body h3:after,.page-bottom-widget h3:after{position:absolute;top:100%;left:30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h3_style == 'border-left-background' ): ?>
/*---左ボーダー＋背景--*/
.article-body h3,.page-bottom-widget h3{padding:6px 0 6px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
<?php endif; ?>
<?php if ( $h3_style == 'border-left' ): ?>
/*---左ボーダー--*/
.article-body h3,.page-bottom-widget h3{padding:6px 0 6px 12px;border-left:4px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h3_style == 'border-left-bottom' ): ?>
/*---左ボーダー+下ボーダ--*/
.article-body h3,.page-bottom-widget h3{padding:6px 0 6px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
<?php endif; ?>
<?php if ( $h3_style == 'border-bottom' ): ?>
/*--下ボーダー--*/
.article-body h3,.page-bottom-widget h3{padding:6px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h3_style == 'border-bottom-two' ): ?>
/*---下ボーダー（2カラー）--*/
.article-body h3,.page-bottom-widget h3{position:relative;padding:6px 0;border-bottom:2px solid #ccc;}
.article-body h3:after,.page-bottom-widget h3:after{position:absolute;bottom:-2px;left: 0;z-index: 2;content: '';width:20%;height:2px;background-color:<?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h3_style == 'border-left-background-stripe' ): ?>
/*---左ボーダー＋背景 ストライプ--*/
.article-body h3,.page-bottom-widget h3{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background:-webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
<?php if ( $h3_style == 'border-top-bottom-stripe' ): ?>
/*--上下ボーダー ストライプ--*/
.article-body h3,.page-bottom-widget h3{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
/*--h4 style--*/
...
.article-body h4:after{position: absolute;top: 100%;left: 30px;content: '';width: 0;height: 0;border: 10px solid transparent;border-top: 15px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h4_style == 'border-left-background' ): ?>
/*---左ボーダー＋背景--*/
.article-body h4{padding:4px 0 4px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
<?php endif; ?>
<?php if ( $h4_style == 'border-left' ): ?>
/*---左ボーダー--*/
.article-body h4{padding:4px 0 4px 12px;border-left:4px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $h4_style == 'border-left-bottom' ): ?>
/*---左ボーダー+下ボーダ--*/
.article-body h4{padding:4px 0 4px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
<?php endif; ?>
<?php if ( $h4_style == 'border-bottom' ): ?>
/*--下ボーダー--*/
.article-body h4{padding:4px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
<?php endif; ?>
...
/*---左ボーダー＋背景 ストライプ--*/
.article-body h4{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
<?php if ( $h4_style == 'border-top-bottom-stripe' ): ?>
/*--上下ボーダー ストライプ--*/
.article-body h4{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
/*--sidebar style--*/
...
.side-widget-title h3:after{position:absolute;top:100%;left: 30px;content:'';width:0;height:0;border:10px solid transparent;border-top:15px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-left-background' ): ?>
/*---左ボーダー＋背景--*/
.side-widget-title h3{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background-color:#f0f0f0;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-left' ): ?>
/*---左ボーダー--*/
.side-widget-title h3{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-left-bottom' ): ?>
/*---左ボーダー+下ボーダ--*/
.side-widget-title h3{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;border-bottom:2px solid #e2e5e8;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-bottom' ): ?>
/*--下ボーダー--*/
.side-widget-title h3{padding:8px 0;border-bottom:2px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-bottom-two' ): ?>
/*---下ボーダー（2カラー）--*/
.side-widget-title {border-bottom:1px solid #e2e5e8;}
.side-widget-title h3 {margin-bottom: -1px;}
.side-widget-title span{display:inline-block;padding:0 4px 4px 0;border-bottom:1px solid <?php echo $main_color; ?>;}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-left-background-stripe' ): ?>
/*---左ボーダー＋背景 ストライプ--*/
.side-widget-title h3{padding:8px 0 8px 12px;border-left:4px solid <?php echo $main_color; ?>;background:-webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background: repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
<?php if ( $sidebar_h_style == 'border-top-bottom-stripe' ): ?>
/*--上下ボーダー ストライプ--*/
.side-widget-title h3{padding:8px 0 8px 16px;border-top:2px solid <?php echo $main_color; ?>;border-bottom:2px solid <?php echo $main_color; ?>;background: -webkit-repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);background:repeating-linear-gradient(-45deg, #ebedf0, #ebedf0 3px, #fff 3px, #fff 8px);}
<?php endif; ?>
...
/*--post cta--*/
.cta-post{border-top:5px solid <?php echo $main_color; ?>;border-bottom:5px solid <?php echo $main_color; ?>;}
/*--post cta common--*/
...
.cta-common-btn input[type=submit]{background-color:<?php echo $cta_common_btn_background_color;?>;color:<?php echo $cta_common_btn_text_color; ?>;border-top: 2px solid rgba(255,255,255,0.2);border-bottom: 4px solid rgba(0,0,0,0.2);}
/*--post cta a--*/
...
.cta-a-btn input[type=submit]{background-color:<?php echo $cta_a_btn_background_color;?>;color:<?php echo $cta_a_btn_text_color; ?>;border-top: 2px solid rgba(255,255,255,0.2);border-bottom: 4px solid rgba(0,0,0,0.2);}
/*--post cta b--*/
...
.cta-b-btn input[type=submit]{background-color:<?php echo $cta_b_btn_background_color;?>;color:<?php echo $cta_b_btn_text_color; ?>;border-top:2px solid rgba(255,255,255,0.2);border-bottom:4px solid rgba(0,0,0,0.2);}
/*--post cta c-*/
...
.cta-c-btn input[type=submit]{background-color:<?php echo $cta_c_btn_background_color;?>;color:<?php echo $cta_c_btn_text_color; ?>;border-top:2px solid rgba(255,255,255,0.2);border-bottom:4px solid rgba(0,0,0,0.2);}
/*--post cta d--*/
...
.cta-d-btn input[type=submit]{background-color:<?php echo $cta_d_btn_background_color;?>;color:<?php echo $cta_d_btn_text_color; ?>;border-top:2px solid rgba(255,255,255,0.2);border-bottom:4px solid rgba(0,0,0,0.2);}
@media screen and ( min-width: 768px ) {
...
<?php endif; ?>
<?php if ( $display_content_sns_follow && !$display_author_profile ): ?>
...
<?php if ( $display_cta_popup_frontpage || $display_cta_popup_single || $display_cta_popup_page || $display_cta_popup_archive ): ?>
/*--cta popup--*/
.cta-popup-inner{background-color:<?php echo $cta_popup_background_color; ?>;}
.cta-popup-header,.cta-popup-header-remodal{border-top: 4px solid <?php echo $cta_popup_title_header_color; ?>;}
...
.cta-popup-btn a {background-color:<?php echo $cta_popup_btn_background_color; ?>;border-top:2px solid rgba(255,255,255,0.2);border-bottom: 4px solid rgba(0,0,0,0.2);color:<?php echo $cta_popup_btn_text_color; ?>;}
.cta-popup-footer input[type=submit]{background-color:<?php echo $cta_popup_btn_background_color;?>;color:<?php echo $cta_popup_btn_text_color; ?>;border-top: 2px solid rgba(255,255,255,0.2);border-bottom:4px solid rgba(0,0,0,0.2);}
...
.cta-footer-section a,.cta-footer-section .fa{color:<?php echo $cta_footer_text_color; ?>;}
...
.footer-nav li{border-right: 1px solid <?php echo $footer_text_color; ?>;}
...
.footer-widget-box h3{border-bottom:1px solid <?php echo $footer_text_color; ?>;}
.footer-widget-box a:hover .fa<?php echo $footer_link_hover; ?>;}
.footer-widget-box #wp-calendar caption{border:1px solid <?php echo $footer_text_color; ?>;border-bottom: none;}
.footer-widget-box #wp-calendar th{border:1px solid <?php echo $footer_text_color; ?>;}
.footer-widget-box #wp-calendar td{border:1px solid <?php echo $footer_text_color; ?>;}
.footer-widget-box #wp-calendar a:hover{color:<?php echo $footer_link_hover; ?>;}
.footer-widget-box .tagcloud a{border:1px solid <?php echo $footer_text_color; ?>;}
.footer-widget-box .tagcloud a:hover{border:1px solid <?php echo $footer_link_hover; ?>;}
...
.footer-widget-box select{border: 1px solid <?php echo $footer_text_color; ?>;color:<?php echo $footer_text_color; ?>;}
...
.lp-header-cta-tell .fa{color:<?php echo $lp_header_cta_icon_color; ?>;}
...
.lp-header{position:relative;height:<?php echo intval( $header_image_height );?>px;}
.lp-header:before{position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(<?php echo $header_image_background_color_degree; ?>deg, <?php echo $header_image_background_color_start; ?>, <?php echo $header_image_background_color_end; ?>)fixed;opacity:<?php echo $header_image_opacity; ?>;content: "";z-index: 100;}
...
.header-btn-bg:before{content:'';position:absolute;border:3px solid <?php echo $header_btn_background_color; ?>;top:0;right:0;bottom:0;left:0;-webkit-transition:.2s ease-in-out;transition:.2s ease-in-out;z-index:-1;}
...
.advantage-icon .fa{border:2px solid <?php echo $advantage_section_icon_color; ?>;color:<?php echo $advantage_section_icon_color; ?>;}
<?php endif; ?>
/*--lp content section--*/
...
.lp-comparison table td:first-child {border:1px solid <?php echo $comparison_section_myitem_background_color; ?>;}
...
<?php endif; ?>
<?php if ( $display_faq_section ): ?>
/*--lp faq section--*/
.lp-faq{color:<?php echo $faq_section_text_color; ?>;background-color:<?php echo $faq_section_background_color; ?>;}
.faq-header h2{color:<?php echo $faq_title_color; ?>;}
.faq-header p{color:<?php echo $faq_sub_title_color; ?>;}
.faq-content .question:before{background-color:<?php echo $faq_section_q_icon_color; ?>;}
.faq-content .answer:before{background-color:<?php echo $faq_section_a_icon_color; ?>;}
<?php endif; ?>
<?php if ( $display_closing_section ): ?>
/*--lp closing section--*/
.lp-closing{background:url(<?php echo esc_url( $closing_section_image ); ?>) no-repeat;background-position:50% 50%;background-repeat:no-repeat;background-attachment:fixed;background-size:cover;}

...
function cta_custom_menu() {
	...
	add_meta_box( 'cta_setting', __( 'CTA setting', 'emanon' ), 'cta_setting_form', 'page', 'side' );
}
...
function cta_setting_form() {
	...
	echo '<label><input type="checkbox" name="emanon_hide_popup_cta" id="emanon_popup_hide_cta" value="1"' . $hide_popup_cta_checked . '/>'. __( 'Hide popup cta' , 'emanon') . '</label>';
}
...
function page_lp_setting_form() {
	...
	echo '<textarea name="emanon_input_hidden" id="emanon_input_hidden" cols="60" rows="4" style="width:99%">' . htmlspecialchars( get_post_meta( $post->ID, 'emanon_input_hidden', true) ) . '</textarea><br>';
